...
LIB_CLASSPATH=$LIBDIR/LbjNerTagger.jar:$LIBDIR/LBJ2Library-2.2.2.jar:$LIBDIR/commons-cli-1.2.jar:/commons-lang-2.4.jar:$LIBDIR/commons-logging-1.1.1.jar::$LIBDIR/h2-1.1.118.jar:$LIBDIR/libthrift.jar:$LIBDIR/logback-classic-0.9.17.jar:$LIBDIR/logback-core-0.9.17.jar:$LIBDIR/slf4j-api-1.5.8.jar
...
java -cp $CLASSPATH -Dhome=$CURATOR_BASE -Xmx2G edu.illinois.cs.cogcomp.annotation.server.IllinoisNERServer $@
cd $START