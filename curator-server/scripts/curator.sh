...
java -cp $CLASSPATH -Dhome=$CURATOR_BASE/curator-server -Xmx512m edu.illinois.cs.cogcomp.curator.CuratorServer -config configs/curator.properties -annotators configs/annotators.xml -port 9090
cd $PWD